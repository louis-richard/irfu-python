...
pltrf.plot_line(axs[3],pparam.Flh)
pltrf.plot_line(axs[3],pparam.Fce)
pltrf.plot_line(axs[3],pparam.Fpp)
...
pltrf.plot_line(axs[4],pparam.Flh)
pltrf.plot_line(axs[4],pparam.Fce)
pltrf.plot_line(axs[4],pparam.Fpp)
...
pltrf.plot_line(axs[5],pparam.Flh)
pltrf.plot_line(axs[5],pparam.Fce)
pltrf.plot_line(axs[5],pparam.Fpp)
