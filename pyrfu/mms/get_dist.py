...
def get_dist(file_path="", cdf_name="", tint=None):
	...
	with pycdf.CDF(file_path) as f:
		if tmmode == "brst":
			...
			en0_name = "_".join([cdf_name.split("_")[0], cdf_name.split("_")[1], "energy0", cdf_name.split("_")[-1]])
			en1_name = "_".join([cdf_name.split("_")[0], cdf_name.split("_")[1], "energy1", cdf_name.split("_")[-1]])
			d_en_name = "_".join(
				[cdf_name.split("_")[0], cdf_name.split("_")[1], "energy_delta", cdf_name.split("_")[-1]])
			e_step_table_name = "_".join(
				[cdf_name.split("_")[0], cdf_name.split("_")[1], "steptable_parity", cdf_name.split("_")[-1]])
			...
			res = ts_skymap(t, dist, None, ph, th, energy0=energy0, energy1=energy1, esteptable=step_table)
